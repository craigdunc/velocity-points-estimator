...
export default function FindOutMoreTAD({ onClose }) {
    const { current, updateWTEFavourites } = useSaveSlots();
    const favorites = new Set(current?.wteFavourites?.[29] || []);
    const [selectedDestination, setSelectedDestination] = useState('All');

    const holidayTypes = [
        { id: '1', name: 'Japan Highlights Tour', dest: 'Asia' },
        { id: '2', name: 'Vietnam & Cambodia Discovery', dest: 'Asia' },
        { id: '3', name: 'Classic Italy & Swiss Alps', dest: 'Europe' },
        { id: '4', name: 'Greek Islands Escapade', dest: 'Europe' },
        { id: '5', name: 'Canadian Rockies & Alaska Cruise', dest: 'Americas' },
        { id: '6', name: 'Highlights of Peru & Machu Picchu', dest: 'Americas' },
        { id: '7', name: 'Taste of Tasmania', dest: 'Domestic' },
        { id: '8', name: 'Top End & Kakadu Explorer', dest: 'Domestic' },
        { id: '9', name: 'South Coast Safari', dest: 'Domestic' },
        { id: '10', name: 'Best of China', dest: 'Asia' },
    ];
    ...
    const toggleFav = (itemId) => {
        updateWTEFavourites(29, String(itemId));
    };
