...
export default function FindOutMoreCruises({ onClose }) {
    const { current, updateWTEFavourites } = useSaveSlots();
    const favorites = new Set(current?.wteFavourites?.[30] || []);
    const [selectedDestination, setSelectedDestination] = useState('All');

    const holidayTypes = [
        { id: '1', name: 'South Pacific Discovery', dest: 'South Pacific' },
        { id: '2', name: 'Fiji & Vanuatu Cruise', dest: 'South Pacific' },
        { id: '3', name: 'New Zealand Splendour', dest: 'South Pacific' },
        { id: '4', name: 'Caribbean Island Hopper', dest: 'Caribbean' },
        { id: '5', name: 'Bahamas & Keys Escape', dest: 'Caribbean' },
        { id: '6', name: 'Western Caribbean Explorer', dest: 'Caribbean' },
        { id: '7', name: 'Mediterranean Romance', dest: 'Mediterranean' },
        { id: '8', name: 'Greek Islands & Adriatic', dest: 'Mediterranean' },
        { id: '9', name: 'Glaciers of Alaska', dest: 'Alaska' },
        { id: '10', name: 'Inside Passage Wildlife', dest: 'Alaska' },
    ];
    ...
    const toggleFav = (itemId) => {
        updateWTEFavourites(30, String(itemId));
    };
            ...
            <div className="flex-grow p-6 overflow-y-auto">
                <div className="flex items-center mb-6 pl-1 pr-1">
                    <div className="w-12 h-12 flex items-center justify-center bg-gray-50 rounded-full mr-4 flex-shrink-0">
                        <img src={CruisesLogo} alt="Qantas Cruises" className="w-8 h-8 object-contain" />
                    </div>
                ...
                <p className="text-[14px] text-[#222222] mb-6 leading-relaxed">
                    Earn 1 point per A$1 spent on your cruise. Qantas partners with the Award-winning Cruise Guru. Choose from the world's most popular lines, ships and destinations.
                </p>
